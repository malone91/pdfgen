...
public class Xml2HtmlTest {
    ...
    public void transferXml2Html() {
        ...
        //创建xml文件输入流
        try {
            inputStream = this.getClass().getClassLoader().getResourceAsStream("xml2html/protocol.xml");
            Source source = new StreamSource(inputStream);
            //创建xsl输入流
            stream = this.getClass().getClassLoader().getResourceAsStream("xml2html/protocol.xsl");
